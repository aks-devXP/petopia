...
//     about:
//       "Experienced pediatrician with a passion for child health and development. Dr. Carter has been practicing for over 10 years and is dedicated to providing comprehensive care for children.",
//     address: "456 Healthway, Suite 201",
//     city: "Mumbai",
//     email: "dr.emily@healthcare.com",
//     name: "Dr. Emily Carter",
//     phone: 9876543211,
//     profilePic: "dr.emily@healthcare.jpg",
//     rating: 4.7,
//     state: "Maharashtra",
//     tenure: 10,
//     timings: [],
...
//                     src={getImgUrl(`../assets/Vet/dr.emily@healthcare.jpg`)}
//                     alt=""
//                   />
//                   <div>
//                     <div className="flex gap-3 items-center">
//                       <p className="font-medium text-4xl">
//                         {Data.name ? name : "Dr. John Doe"}
//                       </p>
//                       <MdVerifiedUser className="w-5 h-5" />
//                     </div>
//                     <div className="mt-2 flex gap-2 items-center">
//                       <p className="font-normal text-md">
//                         MBBS - {spec ? spec : "General Physician"}
//                       </p>
        ...
        <div className="h-fit w-full lg:w-[60%]">
          <div className="h-fit w-full text-black rounded-xl p-10">
            ...
            >
              <img
                className="h-60 w-60 rounded-full shadow-lg"
                src={getImgUrl(`../assets/Vet/${data.profilePic}`)}
                alt="Profile"
              />
              <div>
                <div className="flex gap-3 items-center">
