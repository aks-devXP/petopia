...
const NGO = () => {
  ...
  const path = 'NGO/';
  const list = [
    { name: 'Dog Caring', src: `${path}2e5f69dd-1a6a-4260-b39d-6cc56932d751.jpeg` },
  ...
  const list2 = [
    { name: 'Dog Caring', src: `${path}pexels-ifaw-5486964.jpg` },
  ...
  return (
    <div className="w-full bg-app-bg">
      {/* Hero button scrolls to SupportACause */}
