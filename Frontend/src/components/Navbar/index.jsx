...
import DashboardModal from "@/Pages/admin/profile/components/DashboardModal";
import MainMenu from "./components/MainMenu";
import ProfileDropdown from "../../Pages/admin/profile/components/Dropdown";
...
const Navbar = () => {
  ...
  return (
    <div className="flex w-full h-20">
        <div className="navbar flex h-fit justify-between lg:px-1 sm:px-5 w-full z-20 min-h-20 shadow-[0_0_10px_rgba(229,229,203,0.4)]">
