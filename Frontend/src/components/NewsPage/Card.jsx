...
const Card = ({img='', id='A', topic="Sample Headline", subtopic="Lorem ipsum, dolor sit amet consectetur adipisicing elit. Numquam dolorum tempora rerum sit ratione molestias."}) => {
  return (
    <>  
        <div className='bg-white w-72 sm:w-80 md:w-96 flex-col rounded-3xl overflow-hidden mx-4 border border-gray-200 shadow-sm hover:shadow-lg transition-shadow duration-300'>
        <Link to={`/news/${id}`}>
